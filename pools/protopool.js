...
module.exports = function(poolName, unit) {
  return function(wallet) {
    let options = {
      uri: `http://protopool.net/site/wallet_miners_results?address=${wallet}`,
      headers: {
        Referer: `http://protopool.net/?address=${wallet}`,
    ...
    return rp(options).then(body => {
      ...
      try{
        ...
        throw new PoolError('protopool parse error');
      }
      return rigs;
